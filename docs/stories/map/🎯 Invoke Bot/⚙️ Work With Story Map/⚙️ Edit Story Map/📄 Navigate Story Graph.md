...
**Navigation:** [📄‹ Story Map](../../../../story-map.drawio) | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.py#L30)
...
### Scenario: [Story Map Loads Epics](#scenario-story-map-loads-epics) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.py#L44)
...
### Scenario: [Epic Has Sub Epics](#scenario-epic-has-sub-epics) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.py#L56)
...
### Scenario: [Sub Epic Has Story Groups](#scenario-sub-epic-has-story-groups) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.py#L72)
...
### Scenario: [Story Group Has Stories](#scenario-story-group-has-stories) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.py#L88)
...
### Scenario: [Story Has Properties](#scenario-story-has-properties) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.py#L106)
...
### Scenario: [Story Has Scenarios](#scenario-story-has-scenarios) (happy_path)  | [Test](/test/invoke_bot/edit_story_map/test_edit_story_nodes.py#L123)
...
<a id="scenario-child1"></a>
### Scenario: [Child1](#scenario-child1) ()
