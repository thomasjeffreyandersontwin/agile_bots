...
### Scenario: [User clears all scope filters](#scenario-user-clears-all-scope-filters) ()
...
### Scenario: [User executes build after clearing scope](#scenario-user-executes-build-after-clearing-scope) ()
