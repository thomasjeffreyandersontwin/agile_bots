...
### Scenario: [User sets knowledge graph scope filter](#scenario-user-sets-knowledge-graph-scope-filter) ()
...
### Scenario: [User executes build with active knowledge graph scope](#scenario-user-executes-build-with-active-knowledge-graph-scope) ()
