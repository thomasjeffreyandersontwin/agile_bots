...
**User:** User
**Path:** [🎯 Invoke Bot](../..) / [⚙️ Perform Action](..) / [⚙️ Perform Action Using CLI](..) / [⚙️ Display Render Instructions Through REPL](.)  
...
### Scenario: [Get render instructions with templates](#scenario-get-render-instructions-with-templates) ()
