...
**User:** User
**Path:** [🎯 Invoke Bot](../..) / [⚙️ Perform Action](..) / [⚙️ Perform Action Using CLI](..) / [⚙️ Display Validate Instructions Through REPL](.)  
...
### Scenario: [Get validate instructions with rules](#scenario-get-validate-instructions-with-rules) ()
