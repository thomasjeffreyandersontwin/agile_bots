...
**User:** User
**Path:** [🎯 Invoke Bot](../..) / [⚙️ Invoke Bot Through REPL](..) / [⚙️ Manage Story Graph Using REPL](../..) / [⚙️ Manage Story Scope Using REPL](..) / [⚙️ Filter on Story Scope in CLI](.)  
**Sequential Order:** 4
**Story Type:** user
...
### Scenario: [View scope with no filters set](#scenario-view-scope-with-no-filters-set) (happy_path)
...
### Scenario: [View story scope filter](#scenario-view-story-scope-filter) (happy_path)
...
### Scenario: [View file scope filter](#scenario-view-file-scope-filter) (happy_path)
