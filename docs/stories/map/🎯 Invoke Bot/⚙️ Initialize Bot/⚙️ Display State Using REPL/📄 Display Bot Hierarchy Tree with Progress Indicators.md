...
### Scenario: [User views bot hierarchy with status command](#scenario-user-views-bot-hierarchy-with-status-command) ()
...
### Scenario: [CLI shows completed actions with [x] indicator](#scenario-cli-shows-completed-actions-with-x-indicator) ()
