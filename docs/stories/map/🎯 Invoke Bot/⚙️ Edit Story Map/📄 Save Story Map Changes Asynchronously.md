...
**User:** User  
**Path:** [🎯 Invoke Bot](../..) / [⚙️ Edit Story Map](.)  
...
**Example 1: Move SubEpic within Epic**
...
**Example 2: Move Story within SubEpic**
...
**Example 3: Move Scenario within Story**
...
**Example 1: Delete Story from SubEpic**
...
**Example 2: Delete Scenario from Story**
...
**Example 3: Delete Acceptance Criterion from Story**
...
**Example 1: Create SubEpic under Epic**
...
**Example 2: Create Story under SubEpic**
...
**Example 3: Create Scenario under Story**
...
**Example 1: Batch operations in Edit Story Map SubEpic**
...
**Example 2: Batch operations in Navigate Behavior Actions SubEpic**
...
**Example 1: Empty story name validation error**
...
**Example 2: Invalid characters in scenario name**
...
**Example 3: Duplicate story name hierarchy error**
