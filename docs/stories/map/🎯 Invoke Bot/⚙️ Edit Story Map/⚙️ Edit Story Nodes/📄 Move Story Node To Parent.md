...
### Scenario: [Move node with invalid position adjusts to last](#scenario-move-node-with-invalid-position-adjusts-to-last) (happy_path)
...
### Scenario: [Move node to parent where it already exists returns error](#scenario-move-node-to-parent-where-it-already-exists-returns-error) (happy_path)
...
### Scenario: [Move SubEpic to SubEpic with Stories returns error](#scenario-move-subepic-to-subepic-with-stories-returns-error) (happy_path)
...
### Scenario: [Move Story to SubEpic with SubEpics returns error](#scenario-move-story-to-subepic-with-subepics-returns-error) (happy_path)
...
### Scenario: [Move node to create circular reference returns error](#scenario-move-node-to-create-circular-reference-returns-error) (happy_path)
