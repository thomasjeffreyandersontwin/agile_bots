...
### Scenario: [Create Epic with invalid position adjusts to last](#scenario-create-epic-with-invalid-position-adjusts-to-last) (happy_path)
...
### Scenario: [Create Epic with duplicate name returns error](#scenario-create-epic-with-duplicate-name-returns-error) (happy_path)
...
### Scenario: [Create Epic updates epics collection](#scenario-create-epic-updates-epics-collection) (happy_path)
...
### Scenario: [Create Epic updates underlying story_graph dict](#scenario-create-epic-updates-underlying-story_graph-dict) (happy_path)
...
### Scenario: [Create multiple Epics in sequence](#scenario-create-multiple-epics-in-sequence) (happy_path)
...
### Scenario: [Create Epic at beginning (position 0)](#scenario-create-epic-at-beginning-position-0) (happy_path)
