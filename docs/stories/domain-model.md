...
**Key Responsibilities:**
- **Shows confirmation inline**: This responsibility involves collaboration with Message, DOM Element.
- **Shows confirm and cancel buttons**: This responsibility involves collaboration with Button Set.
- **Invokes callback on confirm**: This responsibility involves collaboration with Callback Function.
- **Hides confirmation on cancel**: This responsibility involves collaboration with DOM Element.
...
**Key Responsibilities:**
- **Shows warning message**: This responsibility involves collaboration with Message Text, DOM Element.
- **Hides message**: This responsibility involves collaboration with DOM Element.
- **Applies message styling**: This responsibility involves collaboration with CSS Class, Message Type.
...
**Key Responsibilities:**
- **Parses dot notation to node path**: This responsibility involves collaboration with Dot Notation String, Path Segments.
- **Resolves node from path**: This responsibility involves collaboration with StoryGraph, Path Segments, StoryNode.
- **Formats navigation error with valid paths**: This responsibility involves collaboration with Error Message, Valid Paths List.

#### FileModificationMonitor

**Key Responsibilities:**
- **Detects file modification**: This responsibility involves collaboration with File System, Last Modified Timestamp.
- **Delegates reload to StoryGraph**: This responsibility involves collaboration with StoryGraph, File Path.
- **Triggers panel refresh**: This responsibility involves collaboration with StoryMapView, DOM.
- **Shows validation error notification**: This responsibility involves collaboration with Error Message, Panel Display.
- **Retains previous valid graph on error**: This responsibility involves collaboration with Previous Graph, StoryGraph.
