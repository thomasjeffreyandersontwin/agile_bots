...
##  Show All Scope
- Show All Scope
- Show All Scope Through CLI
- Show All Scope Through Panel
##  Filter Story Scope
- Direct.Filter on Story Scope.Filter Story Scope
- CLI.Filter on Story Scope.Filter Story Scope
- Panel.Filter on Story Scope.Filter Story Scope

## Get Story Scope Hierarchy
- Get Story Scope Hierarchy
- CLI.Display Story Scope Hierarchy
- Display Story Scope Hierarchy

# Increment: Manage Story Hierarchy
...
## Edit Name of Stories
- Direct.Edit Story Graph.Edit Name  of Stories
- CLI.Edit Story Graph.Edit Name  of Stories
- Panel.Edit Story Graph.Edit Name  of Stories
...
#Increment: Display Domain Concepts
#Increment: Filter Domain Concepts

# Increment: Manage Increments
## Increment: Get Increment Scope View
- Get Increment Scope View
- CLI.Display Increment Scope View
...
## Update Increments Node Name
- Direct.Edit Increments.Update Increments Node name
- CLI.Edit Increments.Update Increments Node name
- Panel.Edit Increments.Update Increments Node name
...
## Increment: Filter Story Scope Using Increment Filter
...
## Increment: Show All Increment Scope
- Show All Increment Scope
- Show All Increment Scope Through CLI
- Show All Increment Scope Through Panel

# Increment : File Filtering

## Increment: Get All Files For Behavior
- Direct.Filter on File Scope.Get All Files For Behavior
- CLI.Filter on File Scope.Display All Files For Behavior
- Panel.Filter on File Scope.Display All Files For Behavior

## Increment: Get Files Filtered By Story Scope
- Get Files Filtered By Story Scope
- CLI.Display Files Filtered By Story Scope
- Display Files Filtered By Story Scope


## Increment: Add Filter Part To File Scope
- Direct.Filter on File Scope.Add Filter Part To File Scope
- CLI.Filter on File Scope.Add Filter Part To File Scope
- Panel.Filter on File Scope.Add Filter Part To File Scope

## Increment: Remove Filter Part From File Scope
- Direct.Filter on File Scope.Remove Filter Part From File Scope
- CLI.Filter on File Scope.Remove Filter Part From File Scope
- Panel.Filter on File Scope.Remove Filter Part From File Scope

## Increment: Filter File Scope
- Direct.Filter on File Scope.Filter File Scope
- CLI.Filter on File Scope.Filter File Scope
- Panel.Filter on File Scope.Filter File Scope

# Increment : Submit Scoped Action
## Increment: Submit Action Scoped To Story Scope
...
## Increment: Submit Action Scoped To Increment
